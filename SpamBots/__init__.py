...
RAID = [
    "KAAL TORNADO HU MADARCHOD TERI MAA KI CHUT ME GHUTKA KHAAKE THOOK DUNGA 🤣🤣",
    "KAAL TORNADO HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "KAAL TORNADO HU TERI VAHEEN NHI HAI KYA? 9 MAHINE RUK SAGI VAHEEN DETA HU 🤣🤣🤩",
    "KAAL TORNADO HU TERI MAA K BHOSDE ME AEROPLANEPARK KARKE UDAAN BHAR DUGA ✈️🛫",
    "KAAL TORNADO HU TERI MAA KI CHUT ME SUTLI BOMB FOD DUNGA TERI MAA KI JHAATE JAL KE KHAAK HO JAYEGI💣",
    "KAAL TORNADO HU TERI MAAKI CHUT ME SCOOTER DAAL DUGA👅",
    "KAAL TORNADO HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "KAAL TORNADO HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "KAAL TORNADO HU TERI MAA KI CHUT KAKTE 🤱 GALI KE KUTTO 🦮 ME BAAT DUNGA PHIR 🍞 BREAD KI TARH KHAYENGE WO TERI MAA KI CHUT",
    "KAAL TORNADO HU DUDH HILAAUNGA TERI VAHEEN KE UPR NICHE 🆙🆒😙",
    "KAAL TORNADO HU TERI MAA KI CHUT ME ✋ HATTH DALKE 👶 BACCHE NIKAL DUNGA 😍",
    "KAAL TORNADO HU TERI BEHN KI CHUT ME KELE KE CHILKE 🍌🍌😍",
    "KAAL TORNADO HU TERI BHEN KI CHUT ME USERBOT LAGAAUNGA SASTE SPAM KE CHODE",
    "KAAL TORNADO HU TERI VAHEEN DHANDHE VAALI 😋😛",
    "KAAL TORNADO HU TERI MAA KE BHOSDE ME AC LAGA DUNGA SAARI GARMI NIKAL JAAYEGI",
    "KAAL TORNADO HU TERI VAHEEN KO HORLICKS PEELAUNGA MADARCHOD😚",
    "KAAL TORNADO HU TERI MAA KI GAAND ME SARIYA DAAL DUNGA MADARCHOD USI SARIYE PR TANG KE BACHE PAIDA HONGE 😱😱",
    "KAAL TORNADO HU TERI MAA KO KOLKATA VAALE JITU BHAIYA KA LUND MUBARAK 🤩🤩",
    "KAAL TORNADO HU TERI MUMMY KI FANTASY HU LAWDE, TU APNI BHEN KO SMBHAAL 😈😈",
    "KAAL TORNADO HU TERA PEHLA KAAL HU MADARCHOD ",
...
RRAID = [
    "KAAL TORNADO HU MADARCHOD",
    "KAAL TORNADO HU BHOSDIKE",
    "KAAL TORNADO HU LAAAWEEE KE BAAAAAL",
